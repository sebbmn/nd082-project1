...
az policy definition create --name tagging-policy --display-name "Deny untagged resources deployement" --description "This policy check if a tag is present on a resource and deny deployement otherwise" --params policy.parameters.json --rules policy.rules.json --mode All
